...
def calculate_fid_given_paths( batch_size, device, dims, num_workers=8):
    ...
    m1, s1 = compute_statistics_of_path(paths1, model, batch_size,
                                        dims, device, num_workers)
    m2, s2 = compute_statistics_of_path(paths2, model, batch_size,
                                        dims, device, num_workers)
